...
public class Log {
     ...
     *
     * @param test ExtentTest instance for the current test
     */
    ...
    /**
     * Logs a failure message and immediately fails the test.
     * 
     * @param message The failure message to log and report
     */
    ...
    /**
     * Logs a warning message to console, Log4j, and ExtentReports.
     * 
     ...
     *
     * @param condition   The boolean condition to check. If true, the test passes; otherwise, it fails.
     * @param passMessage The message to log if the condition is true.
     * @param failMessage The message to log and fail the test if the condition is false.
     */
    ...
    /**
     * Asserts that a boolean condition is true and logs the result.
     * 
    ...
    /**
     * Asserts that a boolean condition is false and logs the result.
     * 
     * @param condition The boolean condition expected to be false
     * @param message   The message describing the assertion
     */
